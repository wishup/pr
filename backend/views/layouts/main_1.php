...
<head>
    ...
    <link href="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/css/layout.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/css/themes/light2.min.css" rel="stylesheet" type="text/css" id="style_color" />
    <link href="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/css/custom.min.css" rel="stylesheet" type="text/css" />
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="<?= Yii::$app->homeUrl; ?>">
                <img src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/logo-invert.png" alt="logo" class="logo-default" /> </a>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <?= (\Yii::$app->controller->id == 'site' && \Yii::$app->controller->action->id == 'index') ? '' : $this->render('//elements/favorites') ?>
            <!-- END THEME PANEL -->
            <!-- BEGIN PAGE BAR -->
            <div class="page-bar">
                <?= Breadcrumbs::widget([
                    ...
                    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar3.jpg" alt="...">
                            ...
                            <li class="media">
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar1.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar4.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar2.jpg" alt="...">
                                <div class="media-body">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                ...
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar6.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar7.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar8.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar9.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar10.jpg" alt="...">
                                <div class="media-body">
                            ...
                            <li class="media">
                                ...
                                <img class="media-object" src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/img/avatar11.jpg" alt="...">
                                <div class="media-body">
...
<div class="page-footer">
    <div class="page-footer-inner"> 2015 &copy; <?= Yii::$app->params["project_name"] ?>
    </div>
...
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/amcharts/amcharts.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/amcharts/serial.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/amcharts/pie.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/amcharts/radar.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/amcharts/themes/light.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/amcharts/themes/patterns.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/amcharts/themes/chalk.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/ammap/ammap.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/ammap/maps/js/worldLow.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/global/plugins/amcharts/amstockcharts/amstock.js" type="text/javascript"></script>
...
<script src="<?= Yii::$app->homeUrl; ?>assets/pages/scripts/dashboard.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<!-- BEGIN THEME LAYOUT SCRIPTS -->
<script src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
<script src="<?= Yii::$app->homeUrl; ?>assets/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
