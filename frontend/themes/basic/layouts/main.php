...
<body class="version1 <?= isset($this->params["bodyClass"]) ? $this->params["bodyClass"] : '' ?>">
<?= Yii::$app->params["settings"]["google_analytics"] ?>
<div id="signinBlock" class="popup-block signin-block  col-lg-9 mfp-hide">
    <?= $this->render("//user/loginpopup") ?>
</div>
<?php $this->beginBody() ?>
<?php
