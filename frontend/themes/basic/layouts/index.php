...
<head>
    ...
    <!-- include the site stylesheet -->
    <link rel="stylesheet" href="<?php echo Yii::$app->homeUrl;?>css/animate.css">
    <!-- include the site stylesheet -->
    <link rel="stylesheet" href="<?php echo Yii::$app->homeUrl;?>css/icon-fonts.css">
    <!-- include the site stylesheet -->
    <link rel="stylesheet" href="<?php echo Yii::$app->homeUrl;?>css/main.css">
    <!-- include the site stylesheet -->
    <link rel="stylesheet" href="<?php echo Yii::$app->homeUrl;?>css/responsive.css">
